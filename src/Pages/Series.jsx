...
const Series = () => {
    ...
    const {
      ...
      const series = products.slice(12, 20);
...
const MainWrapper = styled.div`
    ...
    height: 100vh;
    margin-bottom: 6rem;
    background: linear-gradient(#00000013, #050a13), url("images/series-bak.jpg");
...
const InfoTitle = styled.h3`
    ...
    ${mobile({ fontSize: '1rem', marginTop: '8rem', marginBottom: '-0.6rem'})};
